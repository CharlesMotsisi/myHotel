...
function Luxury(props) {
    ...
    async function checkInNow() {
        if (CheckIn.checkIn !== '' && CheckIn.checkOut !== '') {
            ...
            const querySnapshot = await getDocs(collection(db, "Standard"));
    ...
    return (
        <div className="container">
            ...
            <div className="sale">
                <p>Get 10% discount when you book 2 standard rooms</p>
            </div>
            ...
            <div className="types">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            Standard room gives you<br></br> enough space and confortability<br></br> to make your family not wanna leave
                ...
                <div className={homeBook.content}>
                        ...
                        {data.productData.map((item, index) => (
                            <div className={homeBook.hotel} key={index}>
                                <div className={homeBook.image} /*onClick={() => gallery(listHotels)}*/>
                                    <Link to="/HotelInfo"> <img src="Standard.jpg" alt="" /></Link>
                                </div>
                    ...
                    <div className={homeBook.hotelList}>
                        {data.productData2.map((item, index) => (
                            <div className={homeBook.hotel} key={index}>
                                <div className={homeBook.image} /*onClick={() => gallery(listHotels)}*/>
                                    <Link to="/HotelInfo"> <img src="StandardShare.jpg" alt="" /></Link>
                                </div>
                                <div className={homeBook.description} /*onClick={() => gallery(listHotels)}*/>
                                    <h3>{item.title}</h3><br />
                                    <label>R {item.price}</label><br /><br />
